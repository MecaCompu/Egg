 ...
 */
package ejercicio6dia252627282930_guia8_practicos.Entidad;
 ...
 * Métodos getters y setters de cada atributo.**/
    ...
    public Curso(String nombreCurso, int cantidadHorasPorDia, int cantidadDiasPorSemana, String turno, double precioPorHora, int asistencia) {
    ...
    public String toString() {
        return "Curso{" + "nombreCurso=" + nombreCurso + ", cantidadHorasPorDia=" + cantidadHorasPorDia + ", cantidadDiasPorSemana=" + cantidadDiasPorSemana + ", turno=" + turno + ", precioPorHora=" + precioPorHora + ", alumnos=" + alumnos + ", asistencia=" + asistencia + '}';
    }
